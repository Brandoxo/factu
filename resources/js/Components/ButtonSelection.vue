...
<template>
                ...
                <div class="text-white text-center flex flex-col justify-center items-center gap-6 h-full  absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    ...
                    <button v-if="selectedValue !== null" @click="selectedValue = null" class="bg-red-500 p-2 rounded-md hover:bg-red-600 cursor-pointer transition-all ease-in-out ">Regresar</button>
                </div>
</template>
<style>
  .button-left {
