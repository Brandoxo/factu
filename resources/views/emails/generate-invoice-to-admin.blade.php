...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>COPIA de Comprobante Fiscal Digital por Internet</p>
        </div>
        ...
        <div class="content">
            <p class="greeting">Estimado(a) Administrador de Ronda Minerva,</p>
            <p class="intro-text">
                Esta es una copia de la factura que se ha generado en nuestro sistema Facturatroniks en el Hotel Ronda Minerva. A continuación, encontrará los detalles de la factura del cliente: <strong>{{ $data['cfdiResponse']['Receiver']['Name'] }}</strong>, así como los enlaces para descargar los archivos fiscales en formato PDF y XML.
            </p>
            ...
            <div class="download-section">
                <p class="download-title">📥 Descargue los archivos fiscales</p>
